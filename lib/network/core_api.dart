...
import 'package:voovi/screens/payment/model/subscription_model.dart';
...
import 'package:voovi/screens/rented_content/model/rent_content_model.dart';
import 'package:voovi/screens/search/model/search_response.dart';
...
import 'package:voovi/screens/subscription/model/subscription_model.dart';
...
class CoreServiceApis {
  Future<DashboardDetailResponse> getDashboard() async {
    ...
    final DashboardDetailResponse dashboardDetailsResp = DashboardDetailResponse.fromJson(
  ...
  Future<DashboardDetailResponse> getDashboardDetailOtherData() async {
    final List<String> params = [];
    if (loginUserData.value.id > -1) {
      params.add('user_id=${loginUserData.value.id}');
      if (profileId.value != 0) params.add('profile_id=${profileId.value}');
    ...
    if (cachedDashboardDetailResponse != null) {
      final DashboardDetailResponse res = cachedDashboardDetailResponse ?? DashboardDetailResponse(data: DashboardModel());
      cachedDashboardDetailResponse = dashboardDetailsResp;
  ...
  Future<LiveChannelDashboardResponse> getLiveDashboard() async {
    final LiveChannelDashboardResponse liveChannelDashboardResp = LiveChannelDashboardResponse.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  Future<ProfileDetailResponse> getProfileDet() async {
    final List<String> params = [];
    if (profileId.value != 0) params.add('profile_id=${profileId.value}');
    final ProfileDetailResponse profileDetailResp = ProfileDetailResponse.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  Future<AccountSettingResponse> getAccountSettingsResponse({required String deviceId}) async {
  ...
  //Live Show details
  Future<LiveShowDetailResponse> getLiveShowDetails({required int channelId, int userId = -1}) async {
    final List<String> params = [];
  ...
  //Movie Details
  Future<MovieDetailResponse> getMovieDetails({required int movieId, int userId = -1}) async {
    final List<String> params = [];
  ...
  //Video Details
  Future<VideoDetailResponse> getVideoDetails({required int movieId, int userId = -1}) async {
    final List<String> params = [];
    if (loginUserData.value.id > -1) params.add('user_id=${loginUserData.value.id}');
  ...
  //Episode Details
  Future<EpisodeModel> episodeDetails({required int episodeId, int userId = -1, required int tvShowId, required int seasonId}) async {
    final List<String> params = [];
    if (loginUserData.value.id > -1) params.add('user_id=${loginUserData.value.id}');
    params.add('device_id=${yourDevice.value.deviceId}');
  ...
  //TvShow Details
  Future<TvShowModel> getTvShowDetails({required int showId, int userId = -1}) async {
    final List<String> params = [];
...
// Add/Edit Rating
  Future<BaseResponseModel> addRating({required Map request}) async {
  ...
  Future<BaseResponseModel> deleteRating({required Map request}) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  // Save Download API
  Future<BaseResponseModel> saveDownload({required Map request}) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  Future<BaseResponseModel> deleteFromDownload({required List<int> idList}) async {
    final List<String> params = [];
  ...
  Future<BaseResponseModel> saveContinueWatch({required Map request}) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  // Like Movie
  Future<BaseResponseModel> likeMovie({required Map request}) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  // Watch List Movie
  Future<BaseResponseModel> saveWatchList({required Map request}) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  // Store View Movie
  Future<BaseResponseModel> storeViewDetails({required Map request}) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  // Save Reminder
  Future<BaseResponseModel> saveReminder({required Map request}) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  Future<SubscriptionResponseModel> saveSubscriptionDetails({required Map request}) async {
  ...
  Future<SubscriptionResponseModel> cancelSubscription({required Map request}) async {
    return SubscriptionResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  //Get Genres List
  Future<RxList<GenreModel>> getGenresList({
    int page = 1,
    int? perPage,
  ...
  //Get Actor List
  Future<RxList<PersonModel>> getActorsList({
    String castType = "",
    int page = 1,
    int? perPage,
  ...
  // Movie List API
  Future<RxList<VideoPlayerModel>> getMoviesList({
    int page = 1,
    int? perPage,
    int actorId = -1,
    int genresId = -1,
  ...
  Future<RxList<SliderModel>> getSliderDetail({
...
// Movie List API
  Future<RxList<ChannelModel>> getChannelList({
    int page = 1,
    int perPage = 10,
    int category = -1,
  ...
  // TvShow List API
  Future<RxList<VideoPlayerModel>> getTvShowsList({
    int page = 1,
    int? perPage,
  ...
  // Plan List API
  Future<RxList<SubscriptionPlanModel>> getPlanList({
  ...
  Future<RxList<ComingSoonModel>> getComingSoonList({
    int page = 1,
    int perPage = 10,
    ...
    if (profileId.value != 0) params.add('profile_id=${profileId.value}');
    params.add('per_page=$perPage&page=$page');
    final ComingSoonResponse comingSoonDetails = ComingSoonResponse.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  Future<RxList<VideoPlayerModel>> getContinueWatchingList({
    int page = 1,
    int? perPage,
...
//region Remove from Continue Watching
  Future<BaseResponseModel> removeContinueWatching({required int continueWatchingId}) async {
    final List<String> params = [];
...
//Get Watch List
  Future<RxList<VideoPlayerModel>> getWatchList({
    int page = 1,
    int? perPage,
  ...
  Future<BaseResponseModel> deleteFromWatchlist({required List<int> idList}) async {
    final List<String> params = [];
    params.add('id=${idList.join(',')}');
...
//Get Video List
  Future<RxList<VideoPlayerModel>> getVideoList({
    int page = 1,
    int? perPage,
...
//Get Episodes List
  Future<RxList<EpisodeModel>> getEpisodesList({
    int page = 1,
    int perPage = 10,
    required int showId,
    int seasonId = -1,
...
//Get Review List
  Future<RxList<ReviewModel>> getReviewList({
    int page = 1,
    int perPage = 10,
    int movieId = -1,
...
//Edit Profile API
  Future<void> updateProfileReq({
    ...
    final multiPartRequest = await getMultiPartRequest(APIEndPoints.editProfile);
...
//Page List Setting Screen
  Future<AboutPageResponse> getPageList() async {
  ...
  Future<BaseResponseModel> saveViewCompleted({required Map request}) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
...
// Watching Profile List
  Future<RxList<WatchingProfileModel>> getWatchingProfileList({
    int page = 1,
    int perPage = 10,
    ...
    params.add('per_page=$perPage&page=$page');
    try {
      final WatchingProfileResponse profileResponseModel = WatchingProfileResponse.fromJson(
        await handleResponse(
          await buildHttpResponse(
...
// Watching Edit Profile
  Future<WatchingProfileResponse> updateWatchProfile({
    ...
    final multiPartRequest = await getMultiPartRequest(APIEndPoints.editWatchingProfile);
...
// Watching Delete Profile
  Future<BaseResponseModel> deleteWatchingProfile({required Map request}) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  /// Search Apis
// Save search
  Future<WatchingProfileResponse> saveSearch({required Map request}) async {
...
// Clear All
  Future<WatchingProfileResponse> clearAll(int? isProfileID) async {
    return WatchingProfileResponse.fromJson(
      await handleResponse(
        await buildHttpResponse(
...
// Particular Search Delete
  Future<BaseResponseModel> particularSearchDelete(int id, int profileId) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  Future<List<FAQModel>> getFAQList({
    ...
    final List<String> params = [];
    params.add('per_page=$perPage&page=$page');
    final FAQResponse res = FAQResponse.fromJson(
      await handleResponse(
        await buildHttpResponse(
...
// Plan List API
  Future<RxList<SubscriptionPlanModel>> getSubscriptionHistory({
    int page = 1,
    int perPage = 10,
    ...
    final List<String> params = [];
    params.add('per_page=$perPage&page=$page');
    final SubscriptionResponse profileResponseModel = SubscriptionResponse.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  //Get Coupon List
  Future<RxList<CouponDataModel>> getCouponListApi({
    int page = 1,
    String couponCode = "",
    int? perPage,
    ...
    final CouponListResponse couponListResponse = CouponListResponse.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  Future<BaseResponseModel> changePin(String pin, String confirmPin) async {
    final List<String> params = [];
    params.add('pin=$pin');
  ...
  Future<BaseResponseModel> sendOtp(int userId) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  Future<BaseResponseModel> verifyOtp(int userId, String otp) async {
    final List<String> params = [];
  ...
  Future<BaseResponseModel> updateParentalLock(Map<String, dynamic> request) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
  ...
  Future<BaseResponseModel> linkTvAPI({required Map request}) async {
    return BaseResponseModel.fromJson(
      await handleResponse(
        await buildHttpResponse(
          APIEndPoints.linkTv,
  ...
  Future<RxList<VideoPlayerModel>> getPayPerViewList({
    int page = 1,
    int? perPage,
  ...
  Future<VastAdResponse?> getVastAds() async {
    final VastAdResponse res = VastAdResponse.fromJson(
      await handleResponse(
        await buildHttpResponse(
          getEndPoint(
  ...
  Future<CustomAdResponse?> getCustomAds() async {
    final CustomAdResponse res = CustomAdResponse.fromJson(
      await handleResponse(
        await buildHttpResponse(
          getEndPoint(
