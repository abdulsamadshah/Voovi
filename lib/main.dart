...
Future<void> main() async {
  ...
  if (getStringAsync(SharedPreferenceConst.CONFIGURATION_RESPONSE).isNotEmpty) {
    final ConfigurationResponse configData = ConfigurationResponse.fromJson(jsonDecode(getStringAsync(SharedPreferenceConst.CONFIGURATION_RESPONSE)));
  ...
  isLoggedIn(getBoolValueAsync(SharedPreferenceConst.IS_LOGGED_IN) || getStringAsync(SharedPreferenceConst.USER_DATA).isNotEmpty);
