    ...
    return AppScaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ...
          return couponListCont.getCouponList(showLoader: false);
        },
        child: Padding(
                ...
                AppTextField(
                  ...
                  decoration: inputDecorationWithFillBorder(
                    ...
                    suffixIcon: Row(
                      ...
                      children: [
                        if (couponListCont.isTyping.value) GestureDetector(
                                onTap: () {
                                ...
                                children: [
                                  AnimatedListView(
                                    ...
                                    itemBuilder: (context, index) {
                                      final CouponDataModel couponData = couponListCont.couponList[index];
