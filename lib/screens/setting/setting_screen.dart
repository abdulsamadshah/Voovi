...
import 'package:voovi/screens/setting/faq/f_a_q_screen.dart';
import 'package:voovi/screens/setting/language/language_screen.dart';
import 'package:voovi/screens/setting/otp_verification_bottom_sheet.dart';
...
import 'package:voovi/screens/setting/subscription_history/subscription_history_screen.dart';
import 'package:voovi/screens/setting/subscription_history/rental_history_screen.dart';
                ...
                if (data.isFalse && settingCont.isLoading.isTrue) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final SettingModel settingData = settingCont.settingList[index];
                            ...
                            children: [
                              ...
                              Obx(
                                () {
                                  return Column(
                                    children: [
                                      const Divider(color: greyBtnColor).paddingOnly(left: 30).visible(settingData.showSwitch && settingCont.isChildrenProfileEnabled.value),
                                      //  10.height,
                                      if (settingData.showSwitch && settingCont.isChildrenProfileEnabled.value)
                                        Row(
                                        ...
                                        ).paddingOnly(left: 30).onTap(() async {
                                          if (selectedAccountProfile.value.isProtectedProfile.getBoolInt() && profilePin.value.isNotEmpty) {
                                            ...
                                            await CoreServiceApis().sendOtp(loginUserData.value.id)
                                                .then((value) {
