...
class RemoveReviewComponent extends StatelessWidget {
  final VoidCallback onRemoveTap;

  const RemoveReviewComponent({super.key, required this.onRemoveTap});
    ...
    return Container(
      ...
      child: AnimatedScrollView(
        ...
        children: [
          ...
          30.height,
          Text(
            locale.value.doYouWantToDeleteYourReview,
