...
class MovieDetailsController extends GetxController {
  ...
  Future<void> getMovieDetail({bool showLoader = true}) async {
    ...
    await getMovieDetailsFuture(
      ...
      if (value.data.availableSubTitle.isNotEmpty) {
        ...
        movieData.value.availableSubTitle = value.data.availableSubTitle;
      }
  ...
  Future<void> checkIfAlreadyDownloaded() async {
    ...
    final bool downloaded = await checkIfDownloaded(videoId: movieData.value.id);
    ...
    Get.bottomSheet(
      ...
      AvailableDevicesForCast(
        onTap: (p1) async {
          ...
          Get.to(() => const FlutterChromeCastWidget());
        },
      ),
    );
  }
