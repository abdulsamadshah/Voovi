...
import 'package:voovi/screens/live_tv/live_tv_details/live_tv_details_screen.dart';
              ...
              children: [
                  ...
                  child: homeScreenCont.dashboardDetail.value.slider?.isNotEmpty ?? false
                      ? PageView(
                          ...
                          children: List.generate(
                            ...
                            (index) {
                              final SliderModel data = homeScreenCont.dashboardDetail.value.slider?[index] ??
                                  SliderModel(
                                    id: 0,
                ...
                Positioned(
                  ...
                  child: Row(
                    ...
                    children: [
                      const AppMinLogoWidget(size: Size(30, 30)),
                      const Spacer(),
                      const SubscribeCard(),
                      12.width,
                    ],
          ...
          Row(
            ...
            children: [
              ...
              if (data.imdbRating.isNotEmpty) ...[
                ...
                6.width,
                Text(
                  "${data.imdbRating} ${locale.value.imdb}",
                  style: commonSecondaryTextStyle(size: 12),
                ),
              ],
            ],
