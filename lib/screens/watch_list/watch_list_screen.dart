  ...
  Widget build(BuildContext context) {
    return AppScaffoldNew(
      ...
      body: RefreshIndicator(
        color: appColorPrimary,
        onRefresh: () async {
          return watchListCont.getWatchList();
        },
        child: Obx(
          () => SnapHelperWidget(
                ...
                () => watchListCont.watchList.isEmpty
                    ...
                    : AnimatedScrollView(
                        ...
                        children: [
                          AnimatedWrap(
                            ...
                            children: List.generate(
                              ...
                              (index) {
                                final int reversedIndex = watchListCont.watchList.length - 1 - index;
                                final VideoPlayerModel poster = watchListCont.watchList[reversedIndex];
                                return InkWell(
                                  onTap: () {
                                    if (watchListCont.isDelete.isTrue) {
                                      ...
                                      if (poster.releaseDate.isNotEmpty && isComingSoon(poster.releaseDate)) {
                                        final ComingSoonController comingSoonCont = Get.put(ComingSoonController());
                                        Get.to(
                        ...
                        onSwipeRefresh: () async {
                          watchListCont.page(1);
                          return watchListCont.getWatchList(showLoader: false);
                        },
                      ),
              );
            },
