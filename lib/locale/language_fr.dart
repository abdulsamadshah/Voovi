...
class LanguageFr extends BaseLanguage {
  ...
  @override
  String get pageNotFound => '404 : page introuvable';
  ...
  @override
  String get gatewayTimeout => '504 : expiration du délai de passerelle';
  ...
  @override
  String get dontWorryItHappens => "Ne t'inquiète pas! ça arrive. veuillez saisir l'email associé à votre compte";
  ...
  @override
  String get shareYourThoughtsOnYourFavoriteMovie => 'Partagez vos réflexions sur votre film préféré';
  ...
  @override
  String get subscrption => 'Abonnement';
  ...
  @override
  String get passwordIsRequiredField => 'Le mot de passe est obligatoire';

  @override
  String get confirmPasswordIsRequiredField => 'Confirmer que le mot de passe est obligatoire';

  @override
  String get pleaseEnterConfirmPassword => 'Veuillez saisir le mot de passe confirmé';
  ...
  @override
  String get mobileNumberIsRequiredField => 'Le numéro de portable est un champ obligatoire';
  ...
  @override
  String get stripePay => 'Paiement à rayures';

  @override
  String get razorPay => 'RasoirPay';

  @override
  String get payStackPay => 'Salaire de paie';

  @override
  String get paypalPay => 'Paypal Payer';

  @override
  String get flutterWavePay => 'Paiement FlutterWave';
  ...
  @override
  String get removeFromContinueWatch => 'Voulez-vous supprimer la surveillance continue ?';
  ...
  @override
  String get basedOnYourPreviousWatch => 'Basé sur votre montre précédente';

  @override
  String get mostLiked => 'Les plus aimés';
  ...
  @override
  String get doYouWantToRemoveCoupon => 'Voulez-vous supprimer ce coupon ?';
  ...
  @override
  String rentedesc(int availableFor, String duration) => 'Vous disposez de $availableFor jours pour commencer à regarder une fois la location effectuée. Vous disposerez de $duration heures pour terminer une fois la diffusion commencée.';

  @override
  String youCanWatchThis(int duration) => 'Vous pouvez regarder ce contenu plusieurs fois pendant la période de $duration heures.';
  ...
  @override
  String doYouConfirmThis(String movieName) => 'Confirmez-vous ce plan loué pour $movieName ';
  ...
  @override
  String get scanTvQrCode => 'Scanner le code QR du téléviseur';
